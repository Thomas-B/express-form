...
Field.prototype.arrLength = function (from, to) {
  return this.add(function (arr) {
    if (value.length < from) {
      return { error: message || e.message || " is too short" };
    }
    if (value.length > to) {
      return { error: message || e.message || " is too long" };
    }
    return { valid: true };
  });
}
...
Field.prototype.custom = function(func, message) {
  return this.add(function (value, source) {
    try {
      ...
      return { error: message || e.message || " is invalid" };
    }
...
var MESSAGES = {
  ...
  isUrl: " is not a URL",
  isIP: " is not an IP address",
  isAlpha: " contains non-letter characters",
  isAlphanumeric: " contains non alpha-numeric characters",
  isNumeric: " is not numeric",
  isLowercase: " contains uppercase letters",
  isUppercase: " contains lowercase letters",
  isInt: " is not an integer",
  notEmpty: " has no value or is only whitespace"
};
...
Field.prototype.contains = function (test, message) {
  return this.add(function(value) {
    try {
      ...
      return { error: message || " does not contain required characters" };
    }
    return { valid: true };
  });
};
...
Field.prototype.equals = function (other, message) {
  ...
  return this.add(function (value, source) {
    ...
    if (value != test) {
      return { error: message || " does not equal " + String(test) };
    }
    return { valid: true };
  });
};
...
Field.prototype.isNumeric = function (message) {
  return this.add(function (value) {
    if (object.isNumber(value) || (object.isString(value) && value.match(/^[-+]?[0-9]*\.?[0-9]+$/))) {
      ...
      return { error: message || " is not a number" };
    }
    return { valid: true };
  });
};
...
Field.prototype.isFloat = Field.prototype.isDecimal = function (message) {
  return this.add(function (value) {
    if ((object.isNumber(value) && value % 1 == 0) || (object.isString(value) && value.match(/^[-+]?[0-9]*\.[0-9]+$/))) {
      ...
      return { error: message || " is not a decimal" };
    }
    return { valid: true };
  });
};
...
Field.prototype.regex = Field.prototype.is = function (pattern, modifiers, message) {
  ...
  return this.add(function (value) {
    if (pattern.test(value) === false) {
      return { error: message || " has invalid characters" };
    }
    return { valid: true };
  });
};
